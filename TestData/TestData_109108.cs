	...
	public override FullStudy? FetchStudyData(string sd_sid)
	{
		if (sd_sid == "ITMCTR1900002289")
		{
			...
			fs.identifiers!.Add(new StudyIdentifier(sd_sid, sd_sid, 11, 109108, 
				"International Traditional Medicine Clinical Trial Registry", null, "19 Apr 2019", null));
			...
			sdo.object_dates!.Add(new ObjectDate(sd_oid, 15, false, "19 Apr 2019", 2019, 4, 19, null, null, null, null));
			sdo.object_dates.Add(new ObjectDate(sd_oid, 18, false, "20 Feb 2023", 2023, 2, 20, null, null, null, null));
