...
public class TestData_100117 : TestData_Base
{
    public override FullStudy? FetchStudyData(string sd_sid)
    {
        if (sd_sid == "RBR-386rm8")
        {
            ...
            sb.Append("dizziness or headache) were reported.\nFunctional electrostimulation protocol (FES)\nFunctional electro-stimulation (FES) was applied ");
	        ...
	        sb.Append("\nStudy Design: Clinical intervention / training trial, controlled/randomized, parallel, open with two arms.");
	        ...
	        fs.identifiers!.Add(new StudyIdentifier(sd_sid, sd_sid, 11, 100117, 
		             "Registro Brasileiro de Ensaios Clínicos", null, "31 Oct 2020", null));
	        
	        fs.titles!.Add(new StudyTitle(sd_sid, display_title, 15, "en", 11, true, 
		                             "From the Registro Brasileiro de Ensaios Clínicos"));
	        fs.titles.Add(new StudyTitle(sd_sid, 
		        ...
		        16, "en", 11, false, "From the Registro Brasileiro de Ensaios Clínicos"));
	        ...
	        string ecrit = "Cauda equina injury; spinal shock; venous thrombosis; autonomic dysreflexia; vascular complications; ";
	        ecrit += "pressure ulcers; osteoporosis; recent fracture; implants and femur metal pins and ";
	        ecrit += "two consecutive absences to the training sessions as well.";
	        fs.iec.Add(new StudyIEC(sd_sid, 2, 1002, "none", "All", 0, "e.0A", ecrit));	       
  
	        fs.people!.Add(new StudyPerson(sd_sid, 51, "Gabriel Skiba", 
        ...
        if (sd_sid == "RBR-5cqndz")
        {
	        ...
	        sb.Append("\nPrimary outcome(s): It’s expected that all variables in both groups will be improved, but it will be more significant in ");  
	        ...
	        sb.Append("\nStudy Design: Clinical trial of a randomized, controlled, parallel, double-blind, two-arm treatment trial");
	        string brief_desc = sb.ToString();
	        ...
	        fs.identifiers!.Add(new StudyIdentifier(sd_sid, sd_sid, 11, 100117, 
		             "Registro Brasileiro de Ensaios Clínicos", null, "20 Sep 2018", null));
	        ...
	        fs.people!.Add(new StudyPerson(sd_sid, 51, "Mariane Campos", 
		        "Universidade Federal de São Carlos", 101665,
		        "Universidade Federal de Sao Carlos", "https://ror.org/00qdc6m37"));
	        ...
	        fs.organisations!.Add(new StudyOrganisation(sd_sid, 58, 100652, "Coordenação de Aperfeiçoamento de Pessoal de Nível Superior", "https://ror.org/00x0ma614"));
