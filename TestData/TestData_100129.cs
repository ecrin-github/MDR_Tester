...
public class TestData_100129 : TestData_Base
{
    public override FullStudy? FetchStudyData(string sd_sid)
    {
        if (sd_sid == "PER-015-19")
        {
            ...
            sb.Append("canakinumab matching-placebo in combination with pembrolizumab in addition to 4 cycles of platinum-based doublet "); 
            ...
            fs.identifiers!.Add(new StudyIdentifier(sd_sid, sd_sid, 11, 100129, 
                "Registro Peruano de Ensayos Clínicos", null, "18 Sep 2019", null));
            ...
            title += "PLATINUM-BASED DOUBLET CHEMOTHERAPY WITH OR WITHOUT CANAKINUMAB AS FIRST LINE THERAPY FOR LOCALLY ADVANCED OR METASTATIC NON-SQUAMOUS ";
            title += "AND SQUAMOUS NON-SMALL CELL LUNG CANCER SUBJECTS (CANOPY-1)";
            fs.titles.Add(new StudyTitle(sd_sid, title, 16, "en", 11, false, "From the Registro Peruano de Ensayos Clínicos"));
	        
            fs.people!.Add(new StudyPerson(sd_sid, 51, "Hedwig Schmidt", "Novartis", 
	            100189, "Novartis", "https://ror.org/02f9zrr09"));
            fs.people!.Add(new StudyPerson(sd_sid, 56, "Jose Ortiz", "Novartis", 
	            100189, "Novartis", "https://ror.org/02f9zrr09"));
            ...
            fs.iec.Add(new StudyIEC(sd_sid, 5, 2, "cr", "1.", 1, "e.01", "Previous immunotherapy or treatment with IL-1&#946; inhibitor."));	       
