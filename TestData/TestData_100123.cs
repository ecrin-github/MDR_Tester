...
public class TestData_100123 : TestData_Base
{
    public override FullStudy? FetchStudyData(string sd_sid)
    {
        if (sd_sid == "2009-011622-34")
        {
	        ...
	        fs.iec.Add(new StudyIEC(sd_sid, 3, 1, "seq", "•", 2, "n.02.01", "The number of tender joints is the same or more than the core study baseline OR,"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 4, 1, "seq", "•", 2, "n.02.02", "There is no improvement compared with the core study baseline in at least three of the following five domains: patient global assessment, physician global assessment, patient pain assessment, Health Assessment Questionnaire and CRP."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 5, 1, "cr", "3.", 1, "n.03", "Women of childbearing potential must be using simultaneously double-barrier or two highly effective methods of contraception, (e.g. intra-uterine device plus condom,diaphragm plus condom, etc; hormone replacement as either oral or implantable isacceptable as one form), from the time of screening for the duration of the entire study, up to study completion and up to 16 weeks post last drug administration. Periodic abstinence (e.g. calendar, ovulation, symptothermal, post-ovulation methods) and withdrawal are not acceptable methods of contraception."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 5, 1, "cr", "4.", 1, "n.04", "Male patients willing to use simultaneously two highly effective methods of contraception (e.g. intra-uterine device plus condom) for the duration of the entire study, up to study completion visit and up to 16 weeks post the last drug administration. Periodic abstinence and withdrawal are not acceptable methods of contraception."));	
	        
	        fs.iec.Add(new StudyIEC(sd_sid, 6, 2, "cr", "1.", 1, "e.01", "Patients for whom continued treatment with AIN457 in the extension is not considered appropriate by the treating physician."));	       
	        fs.iec.Add(new StudyIEC(sd_sid, 7, 2, "cr", "2.", 1, "e.02", "Patients who were non-compliant or who demonstrated a major protocol deviation in the core CAIN457A2206 study."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 8, 2, "cr", "3.", 1, "e.03", "Patients who discontinued from the core CAIN457A2206 study before Visit 14 (Week 16)"));
	        fs.iec.Add(new StudyIEC(sd_sid, 9, 2, "cr", "4.", 1, "e.04", "Female patients who are pregnant or lactating."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 10, 2, "cr", ".", 1, "e.05", "Any active systemic infection within the past 2 weeks including a positive chest X-ray."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 11, 2, "cr", "6.", 1, "e.06", "Positive human immunodeficient virus (HIV: ELISA and Western blot) test result,Hepatitis B surface antigen (HBsAg) or Hepatitis C test result, where patients have been re-tested.The following Exclusion Criteria as defined in the core trial [CAIN457A2206] will continue to be valid with minor revisions:"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 12, 2, "cr", "7.", 1, "e.07", "Positive Purified Protein Derivative (PPD) tuberculin skin test of ≥ 5 mm at baseline, (where patients have been re-tested). A positive PPD test will be defined using the MMWR 2000 guidance, summarized as criteria for tuberculin positivity by risk group. A PPD test should not be done in subjects who had a tuberculosis vaccination in the past. These subjects will be eligible to participate if – according to local guidelines – latent tuberculosis can be excluded. For those study sites using QuantiFeron test a positive test at baseline (where patients have been re-tested) will exclude the subject from the participation in the study. If the result for either PPD or QuantiFeron test is indeterminate the subject will be excluded."));	  
	        fs.iec.Add(new StudyIEC(sd_sid, 12, 2, "cr", "8.", 1, "e.08", "For previous use of immunosuppressive agents a wash-out period of at least 1 month or 5 half-lives, whatever is longer, is required. Immunosuppressive agent include but are not limited to cyclosporine, mycophenolate, tacrolimus, and 5-aminosalicylic acid (5-ASA).\nIf on previous treatment with anti-TNF-α therapy (or other biological therapy), thefollowing washout periods will be required for such patients to be eligible to participate in the trial."));	  
	        fs.iec.Add(new StudyIEC(sd_sid, 13, 2, "cr", "•", 2, "e.08.01", "Six (6)-months wash out prior to dosing for alefacept, rituxan and raptiva,"));	       
	        fs.iec.Add(new StudyIEC(sd_sid, 14, 2, "cr", "•", 2, "e.08.02", "Three (3)-months washout prior to baseline for adalimumab and certolizumab,"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 15, 2, "cr", "•", 2, "e.08.03", "Two (2)-months washout prior to baseline for etanercept and infliximab."));
	        fs.iec.Add(new StudyIEC(sd_sid, 16, 2, "cr", "•", 2, "e.08.04", "One (1) month washout prior to baseline for systemic immunosuppressants including, but not limited to azathioprine, cyclosporine and leflunomide.Patients on concomitant prednisone, Methotrexate (MTX) or SSZ can be included,whereby:"));	       
	        fs.iec.Add(new StudyIEC(sd_sid, 17, 2, "cr", "•", 2, "e.08.05", "Prednisone should be kept at a stable dose 4 weeks before baseline and throughout the study and not exceed 10 mg/day."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 18, 2, "cr", "•", 2, "e.08.06", "MTX should be kept at a stable dose 4 weeks before baseline and throughout thestudy and not exceed 25 mg/week."));
	        fs.iec.Add(new StudyIEC(sd_sid, 19, 2, "cr", "•", 2, "e.08.07", "SSZ should be kept at a stable dose 4 weeks before baseline and throughout the study"));
	        fs.iec.Add(new StudyIEC(sd_sid, 20, 2, "cr", "9.", 1, "e.09", "Patients who are on NSAIDS should be kept at a stable dose 4 weeks before baseline and throughout the study."));	 
        ...
        if (sd_sid == "2004-001569-16")
        {
	        ...
	        fs.iec!.Add(new StudyIEC(sd_sid, 1, 1, "seq", "·", 1, "n.01", "In or out patients of both genders"));	       
	        fs.iec.Add(new StudyIEC(sd_sid, 2, 1, "seq", "·", 1, "n.02", "Aged up to 11 years of age at the first visit,"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 3, 1, "seq", "·", 1, "n.03", "Patient requiring for any underlying pathology at least 5 days of total parenteral nutrition, representing at least 90% of their total energy needs,"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 4, 1, "seq", "·", 1, "n.04", "Patient to be supplemented by intravenous vitamins,"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 5, 1, "seq", "·", 1, "n.05", "Patient whose parents or legal representative have freely given their written informed consent."));	    
	        
	        fs.iec.Add(new StudyIEC(sd_sid, 6, 2, "seq", "·", 1, "e.01", "Known HIV infection,"));	       
	        fs.iec.Add(new StudyIEC(sd_sid, 7, 2, "seq", "·", 1, "e.02", "Known pre-existing hypervitaminosis,"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 8, 2, "seq", "·", 1, "e.03", "Known hypersensitivity to intravenous vitamins, or any excipients of the preparation,"));
	        fs.iec.Add(new StudyIEC(sd_sid, 9, 2, "seq", "·", 1, "e.04", "Participation in another clinical trial within a month prior to the first visit,"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 10, 2, "seq", "·", 1, "e.05", "Patient with any underlying pathology at risk of foreseeable drop out before the 6th day,"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 11, 2, "seq", "·", 1, "e.06", "Patients requiring treatment by anticonvulsants (barbiturics or phenytoin),"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 12, 2, "seq", "·", 1, "e.07", "Patients requiring an extra supplementation by products containing vitamins, whatever the route,"));	   
	        fs.iec.Add(new StudyIEC(sd_sid, 11, 2, "seq", "·", 1, "e.08", "Previous inclusion in this study,"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 12, 2, "seq", "·", 1, "e.09", "Parents or legal representative’s potential non-cooperation or unwillingness to comply fully with the protocol."));	   
        ...
        if (sd_sid == "2012-000615-84")
        {
	        ...
	        fs.iec!.Add(new StudyIEC(sd_sid, 1, 301, "seq", "Hdr", 1, "n.00", "A patient will be eligible for inclusion in this study if all of the following criteria apply."));	
	        fs.iec.Add(new StudyIEC(sd_sid, 2, 1, "seq", "1.", 1, "n.01", "Relapsed osteosarcoma (first, second, third or any relapse, patient has recovered from chemotherapy and any other investigational drug/agent treatment, radiotherapy or surgical procedure)"));	       
	        fs.iec.Add(new StudyIEC(sd_sid, 3, 1, "seq", "2.", 1, "n.02", "Histological confirmed diagnosis of osteosarcoma at original presentation."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 4, 1, "seq", "3.", 1, "n.03", "Tumour at biopsy accessible or resectable site."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 5, 1, "seq", "4.", 1, "n.04", "Progressive disease documented by imaging within 3 months of entry into the trial."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 6, 1, "seq", "5.", 1, "n.05", "At least one measurable lesion on CT scan (RECIST) performed in past 21 days prior to trial entry."));	  
	        fs.iec.Add(new StudyIEC(sd_sid, 7, 1, "seq", "6.", 1, "n.06", "Male or female, age ≥ 16 years to 65 (or ≥18 based on institutional practice for Teenage and Young Adult Cancer patients)."));	       
	        fs.iec.Add(new StudyIEC(sd_sid, 8, 1, "seq", "7.", 1, "n.07", "Life expectancy of at least 3 months."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 9, 1, "seq", "8.", 1, "n.08", "WHO performance score of 0 – 2."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 10, 1, "seq", "9.", 1, "n.09", "The patient is willing and able to comply with the protocol and scheduled follow-up visits and examinations."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 11, 1, "seq", "10.", 1, "n.10", "Written (signed and dated) informed consent."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 12, 1, "seq", "11.", 1, "n.11", "Cardiac shortening fraction ≥ 28% or ejection fraction ≥ 45%"));	       
	        fs.iec.Add(new StudyIEC(sd_sid, 13, 1, "seq", "12.", 1, "n.12", "Renal function is adequate for ifosfamide treatment (GFR as per table below, other renal function screening tests as per local practice)"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 14, 1, "seq", "13.", 1, "n.13", "Haematological and biochemical indices within the ranges detailed in the protocol"));	    
	        
	        fs.iec!.Add(new StudyIEC(sd_sid, 15, 302, "seq", "Hdr", 1, "n.00", "A patient will be eligible for inclusion in this study if all of the following criteria apply."));	
	        fs.iec.Add(new StudyIEC(sd_sid, 16, 2, "seq", "1.", 1, "e.01", "Pregnant or breast-feeding woman. Men or women of childbearing potential unless effective methods of contraception are used during study treatment and for at least 7 days after the last mifamurtide dose."));	       
	        fs.iec.Add(new StudyIEC(sd_sid, 17, 2, "seq", "2.", 1, "e.02", "Previous treatment with mifamurtide or a mifamurtide-like drug* in a clinical trial setting for the treatment of metastatic and/or recurrent osteosarcoma in the six months prior to registration."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 18, 2, "seq", "3.", 1, "e.03", "Contraindications to lung biopsies"));
	        fs.iec.Add(new StudyIEC(sd_sid, 19, 2, "seq", "4.", 1, "e.04", "Hypersensitivity to ifosfamide or any component of the formulation."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 20, 2, "seq", "5.", 1, "e.05", "Previously diagnosed brain metastases."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 21, 2, "seq", "6.", 1, "e.06", "Significant active cardiac disease including: uncontrolled high blood pressure (no greater than 2 standard deviations above the mean for age for systolic blood pressure (SBP) and diastolic blood pressure (DBP), unstable angina, congestive heart failure, myocardial infarction within the previous 6 months, or serious cardiac arrhythmias and with a history of pericarditis and myocarditis"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 22, 2, "seq", "7.", 1, "e.07", "Treatment with any other investigational agent, or participation in another interventional clinical trial within 21 days prior to enrolment."));	   
	        fs.iec.Add(new StudyIEC(sd_sid, 23, 2, "seq", "8.", 1, "e.08", "Major surgery within 21 days prior first study biopsy"));	       
	        fs.iec.Add(new StudyIEC(sd_sid, 24, 2, "seq", "9.", 1, "e.09", "Currently taking of high-dose non-steroidal anti-inflammatory drugs (NSAIDs) or corticosteroid treatment"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 25, 2, "seq", "10.", 1, "e.10", "Concurrent use of ciclosporin or other calcineurin inhibitors."));
	        fs.iec.Add(new StudyIEC(sd_sid, 26, 2, "seq", "11.", 1, "e.11", "Any psychological, social or medical condition, physical examination finding or a laboratory abnormality that the Investigator considers would make the patient a poor trial candidate or could interfere with protocol compliance or the interpretation of trial results."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 27, 2, "seq", "12.", 1, "e.12", "Any other active malignancy, with the exception of adequately treated cone-biopsied in situ carcinoma of the cervix uteri and non-melanoma skin lesions."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 28, 2, "seq", "13.", 1, "e.13", "Patients who are known to be serologically positive for Hepatitis B, Hepatitis C or HIV.* mifamurtide-like drugs include GMCSF, interferon and other macrophage activating molecules."));	    
        ...
        if (sd_sid == "2013-001036-22")
        {
	        ...
	        fs.iec.Add(new StudyIEC(sd_sid, 10, 1, "cr", "5.", 1, "n.05", "Estado funcional del ECOG de 0 ó 1"));	    
        ...
        if (sd_sid == "2015-000556-14")
        {
	        ...
	        fs.iec!.Add(new StudyIEC(sd_sid, 1, 1, "seq", "1.", 1, "n.01", "Firma del consenso informato: I pazienti devono essere disposti e capaci a fornire il proprio consenso informato scritto prima di ogni altra procedura di screening prevista per lo studio."));	       
	        fs.iec.Add(new StudyIEC(sd_sid, 2, 1, "seq", "2.", 1, "n.02", "Disponibilità di materiale tumorale raccolto e conservato secondo le procedure del Laboratorio di Terapia Cellulare Somatica IRST."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 3, 1, "seq", "3.", 1, "n.03", "Diagnosi istologica o citologica confermata di RCC (tutte le istologie tranne carcinoma uroteliale)"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 4, 1, "seq", "4.", 1, "n.04", "Stadio IV, in progressione dopo almeno una linea di terapia con TKI e/o antiangiogenetici e/o inibitori di mTOR (i pazienti dovranno aver terminato i precedenti trattamenti almeno 4 settimane prima della prima dose di IL-2)"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 5, 1, "seq", "5.", 1, "n.05", "I pazienti dovranno avere almeno una lesione misurabile, secondo i criteri di risposta irRC (vedere sezione 8), dopo asportazione del tessuto tumorale per la preparazione dei vaccini. Le lesioni tumorali che verranno irradiate sono esclusi dalla valutazione della risposta"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 6, 1, "seq", "6.", 1, "n.06", "Aspettativa di vita superiore a 3 mesi"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 7, 1, "seq", "7.", 1, "n.07", "ECOG performance status 0-1"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 8, 1, "seq", "8.", 1, "n.08", "Funzionalità midollare e d’organo definite come:-leucociti>4000/L-neutrofili >1,500/L-piastrine>100,000/L-bilirubina totale nei limiti della norma (nil)- AST(SGOT)/ALT(SGPT) <2.5 X institutional upper limit of normal- creatinina< 1.5 mg/dl- emoglobina >8.0 gm/dl- ematocrito <30%"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 9, 1, "seq", "9.", 1, "n.09", "ECG ed ecocardiogramma nella norma"));	  
	        fs.iec.Add(new StudyIEC(sd_sid, 10, 1, "seq", "10.", 1, "n.10", "Normale funzionalità polmonare"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 11, 1, "seq", "11.", 1, "n.11", "Non controindicazioni nell’uso di agenti vasopressori"));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 12, 1, "seq", "12.", 1, "n.12", "Test per HIV, HBV HCV e sifilide negativi non più vecchi di 30 giorni prima dell’esecuzione di qualunque procedura GCP."));	    
	        fs.iec.Add(new StudyIEC(sd_sid, 13, 1, "seq", "13.", 1, "n.13", "Uomini e donne di età superiore a 18 anni."));	  
