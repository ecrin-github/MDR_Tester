...
public class TestData_100132 : TestData_Base
{
    public override FullStudy? FetchStudyData(string sd_sid)
    {
        if (sd_sid == "NL1376")
        {
            ...
            sdo.object_dates.Add(new ObjectDate(sd_oid, 18, false, "2023 Apr 3", 2023, 4, 3, null, null, null, null));
        ...
        if (sd_sid == "NL8683")
        {
            ...
            // no country list ? - always in Netherlands?
            ...
            fs.iec.Add(new StudyIEC(sd_sid, 6, 1, "cr", "4.", 1, "n.06", "No history of intestinal illness"));	    
            fs.iec.Add(new StudyIEC(sd_sid, 7, 1, "cr", "5.", 1, "n.07", "Stable body weight over the last three months\n8.No blood donation 2 months prior to the study and during the study"));	  
            
            fs.iec.Add(new StudyIEC(sd_sid, 8, 2, "cr", "1.", 1, "e.01", "Age under 18 and over 65 years"));	       
            fs.iec.Add(new StudyIEC(sd_sid, 9, 2, "cr", "2.", 1, "e.02", "BMI under 20 and over 37 kg/m2"));	    
            fs.iec.Add(new StudyIEC(sd_sid, 10, 2, "cr", "3.", 1, "e.03", "Medication or disease that could interfere with the results of the study, to be judged by the responsible medical doctor"));
            fs.iec.Add(new StudyIEC(sd_sid, 11, 2, "cr", "4.", 1, "e.04", "Recent blood donation within 2 months prior to the start of the study"));	    
            fs.iec.Add(new StudyIEC(sd_sid, 12, 2, "cr", "5.", 1, "e.05", "Intestinal illness at any time in the past"));	    
            fs.iec.Add(new StudyIEC(sd_sid, 13, 2, "cr", "6.", 1, "e.06", "Female"));	    
            fs.iec.Add(new StudyIEC(sd_sid, 14, 2, "cr", "7.", 1, "e.07", "Smokers"));	   
