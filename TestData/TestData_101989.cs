...
public class TestData_101989 : TestData_Base
{
    public override FullStudy? FetchStudyData(string sd_sid)
    {
        if (sd_sid == "LBCTR2019070214")
        {
	        ...
	        sb.Append("Vital signs, Physical exam, Urinalysis, X-Ray;ICF, IMP, Lab tests\n"); 
	        ...
	        fs.identifiers!.Add(new StudyIdentifier(sd_sid, sd_sid, 11, 101989, 
		        "Lebanon Clinical Trial Registry", null, "27 Feb 2023", null));
	        fs.identifiers.Add(new StudyIdentifier(sd_sid, "NCT03631199", 11, 100120,
		        "ClinicalTrials.gov", null, null, null));
	        
	        fs.titles!.Add(new StudyTitle(sd_sid, display_title, 15, "en", 11, true, "From the Lebanon Clinical Trial Registry"));
	        ...
	        fs.titles!.Add(new StudyTitle(sd_sid, title, 16, "en", 11, false, "From the Lebanon Clinical Trial Registry"));
			...
			sdo.data_object = new DataObject(sd_oid, sd_sid, "Lebanese registry web page", null, ob_title,
