	...
	{
		{
			if (sd_sid == "SLCTR-2008-006")
			{
				...
				sb.Append("Primary outcome(s): The primary objective of this trial is to determine whether abetimus sodium is more effective than place in ");  
				...
				sb.Append("Study Design: Randomized controlled trial");
				...
				fs.identifiers!.Add(new StudyIdentifier(sd_sid, sd_sid, 11, 100130, 
					"Sri Lanka Clinical Trials Registry", null, "2008 Mar 28", null));
	        
				fs.titles!.Add(new StudyTitle(sd_sid, display_title, 15, "en", 11, true, 
					"From the Sri Lankan Clinical Trials Registry"));
				...
				fs.titles.Add(new StudyTitle(sd_sid, title, 16, "en", 11, false, "From the Sri Lankan Clinical Trials Registry"));
				...
				fs.iec!.Add(new StudyIEC(sd_sid, 1, 301, "seq", "hdr", 1, "n.00","Males or females between 12 and 70 years old, inclusive Female patients must be non-pregnant and non-lactating and have a negative urine pregnancy test result prior to enrollment in the study. Female patients of childbearing potential (including peri menopausal women who have had a menstrual period within 1 year) must be using appropriate birth control (defined as a method which results in a low failure rate of less than 1% per year, when used consistently and correctly, for example oral contraceptives, contraceptive patch, implants, injectables, some intrauterine contraceptive devices [IUDs], or sexual abstinence) during the entire duration of the study. Males enrolled in the trial must have no plans to father a child during the course of the trial and agree to use adequate birth control methods Diagnosis of SLE for purposes of this trial utilize the 1996 Revised Criteria for the Classification of SLE as defined by the American College of Rheumatology (ACR) where a diagnosis of SLE is established when = 4 of the 11 criteria are met"));	       
				fs.iec.Add(new StudyIEC(sd_sid, 2, 1, "seq", "1.", 1, "n.01", "At least one documented episode of active SLE renal disease within 4 years prior to randomization at study Visit 3"));	    
				fs.iec.Add(new StudyIEC(sd_sid, 3, 1, "seq", "2.", 1, "n.02", "Elevated anti-dsDNA antibody concentration at pre-screening Visit 0 (= 10 IU/mL) as measured by the Farr assay at the regional central laboratory"));	    
				fs.iec.Add(new StudyIEC(sd_sid, 4, 1, "seq", "3.", 1, "n.03", "Ability to communicate meaningfully with the investigational staff, competence to give written informed consent, and ability to comply with the entire study procedure"));	    
				fs.iec.Add(new StudyIEC(sd_sid, 5, 1, "seq", "4.", 1, "n.04", " Duly executed, written, informed consent obtained from the patient, next of kin, or other legal representative"));	 
				...
				sdo.object_dates!.Add(new ObjectDate(sd_oid, 15, false, "2008 Mar 28", 2008, 3, 28, null, null, null, null));
			...
			if (sd_sid == "SLCTR-2021-023")
			{
				...
				StringBuilder sb = new StringBuilder("Interventions: Study settings: <br>Six Teaching Hospitals in Sri Lanka- Teaching Hospital, Mahamodara, ");
				...
				sb.Append("prepared by an independent <br>statistician and maintained centrally by the central coordinating center (central telephone ");
				sb.Append("randomisation by the research nurse/doctor from De Soysa Hospital for Women, Colombo).  Allocation ratio - 1:1.\nd. ");
				sb.Append("Method of allocation concealment- Central telephone randomisation. <br><br>Intervention<br><br>Eligible women will be identified ");
				...
				sb.Append("sheets will be provided and informed written consent will be taken from all eligible women.<br><br>Thereafter, a vaginal examination ");
				...
				sb.Append("Primary outcome(s): Vaginal delivery rate\n\n [At the time of hospital discharge]\n Perinatal morbidity and ");  
				...
				fs.identifiers!.Add(new StudyIdentifier(sd_sid, sd_sid, 11, 100130, 
					"Sri Lanka Clinical Trials Registry", null, "2021 Aug 4", null));
				...
				fs.titles.Add(new StudyTitle(sd_sid, 
					...
					16, "en", 11, false, "From the Sri Lankan Clinical Trials Registry"));
				
				fs.people!.Add(new StudyPerson(sd_sid, 51, "Malitha Patabendige", 
					"Consultant Obstetrician and Gynaecologist", null, "Consultant Obstetrician and Gynaecologist", null));	
            
				fs.organisations!.Add(new StudyOrganisation(sd_sid, 54, null, "Malitha Patabendige", null));
				fs.organisations.Add(new StudyOrganisation(sd_sid, 58, null, 
				...
				fs.conditions!.Add(new StudyCondition(sd_sid, "Pregnancy", null, null, null, null));
				...
				sdo.object_dates!.Add(new ObjectDate(sd_oid, 15, false, "2021 Aug 4", 2021, 8, 4, null, null, null, null));
				sdo.object_dates.Add(new ObjectDate(sd_oid, 18, false, "2023 May 29", 2023, 5, 29, null, null, null, null));
